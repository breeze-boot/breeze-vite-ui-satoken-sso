 ...
 * @description 分发验证码使用
 */
import VerifyPoints from '@/components/anj-plus/verify/VerifyPoints.vue'
import VerifySlide from '@/components/anj-plus/verify/VerifySlide.vue'
...
export default {
  ...
  setup(props) {
    ...
    const componentType = ref('VerifyPoints')
